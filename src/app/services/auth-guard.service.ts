...
export class AuthGuard implements CanActivate{
    ...
    canActivate(route: ActivatedRouteSnapshot,state: RouterStateSnapshot): Observable<boolean> | Promise<boolean> | boolean //il va return soit un  Observable qui sera de type boolean soit ...
    {
